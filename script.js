...
class AIChat {
    ...
    findAnswer(question) {
        ...
        return "Ну Вы ваще даёте! Я же не СуперПупер БОТ на крутейшем сервере. Я могу рассказать Вам о проектах Сергея, или его опыте навыках в медиа-производстве, увлечениях. Что интересует? Не стесняйте спрашивать";
    }
