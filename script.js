...
const quotes = [
    ...
    "«Если когда~нибудь Иван Ургант в интервью у меня спросит, на что я потратил девять лет после того, как я от него ушёл ~ отвечу, не тая: 98% времени я потратил на то, чтобы объяснить, чем же я занимаюсь. Потому что «Просто Живу» — они почему-то не понимали.»",
