...
class AIChat {
    ...
    addWelcomeMessage() {
        ...
        if (messages.children.length === 0) {
            this.addMessage('Привет! Я AI-ассистент Сергея. Можете пораспрашивать меня о нём, его опыте, навыках, увлечениях! И даже чуть больше, чего нет на сайте😊.', 'bot');
        }
    }
    ...
    findAnswer(question) {
        ...
        return "Ну Вы ваще даёте! Я же не СуперПупер БОТ на крутейшем сервере. Я могу рассказать Вам о проектах Сергея, или его опыте навыках в медиа-производстве, увлечениях. Что интересует? Не стесняйтесь, спрашивайте 🤟";
    }
