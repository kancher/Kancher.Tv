...
class AIChat {
    ...
    addWelcomeMessage() {
        ...
        if (messages.children.length === 0) {
            this.addMessage('Привет! Я AI-ассистент Сергея Канчера. Можете пораспрашивать меня о нём, его опыте, навыках, увлечениях! И даже чуть больше, чего нет на сайте😊.', 'bot');
        }
    }
